...
ALTER PROCEDURE [dw_util].[Update_Dates] 
...
--* */
    ...
    IF NOT (EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'Dates')) BEGIN
        CREATE TABLE dw_dim.Dates (
    ...
    END
    ELSE BEGIN
        SELECT @l_Start_Date = COALESCE(DATEADD(dd, 1, MAX(Full_Date)), @d_Start_Date) FROM dw_dim.Dates;
    ...
    INSERT dw_dim.Dates WITH (TABLOCKX)
    SELECT
